...
from utils import find_required_shapes, add_branch_nodes
...
if len(module_nodes) >= 1:
    ...
    # Create two branch modules with different output sizes
    branch1_module = nn.Linear(10, random.randint(1, 1000))
    branch2_module = nn.Linear(10, random.randint(1, 1000))
